...
router.post('/orders', async (req, res) => {
  ...
  const customer_id = req.body.customer_id;
    ...
    try {
      const order_info = await controller.create(consignee_first_name, consignee_middle_name, consignee_last_name, consignee_email, consignee_contact_number, delivery_address, zip_code, status, shopping_cart_id, customer_id);
      res.status(200).json({
        status: 200,
